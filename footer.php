            ...
            <div class="col-md-3">
                ...
                <ul class="menu-list">
                    <?php if(!empty($footer[0]['contact_address'])){ ?>
                        <li><i class="fa fa-home" ></i><span>panoAkil sukkur Sindh</span></li>
                    <?php } ?>
                    <?php if(!empty($footer[0]['contact_phone'])){ ?>
                        <li><i class="fa fa-phone" ></i><span>: 03113541598 </span></li>
                    <?php } ?>
                    <?php if(!empty($footer[0]['contact_email'])){ ?>
                        <li><i class="fa fa-envelope" ></i><span>khaldi8014@gmail.com</span></li>
                    <?php } ?>
                </ul>
            </div>
            <div class="col-md-12">
                <span><?php echo $footer[0]['footer_text'] ?> | Created by <a href="#" target="_blank">Ashfaque Ahmed</a></span>
            </div>
        </div>
    </div>
</div>
